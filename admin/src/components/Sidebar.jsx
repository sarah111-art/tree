    ...
    <div className="w-64 h-screen bg-green-800 text-white fixed top-0 left-0 flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-4">
        ...
        <div>
          ...
          {categoryMenuOpen && (
            <div className="ml-6 mt-2 space-y-2 text-sm">
              <Link to="/admin/categories" className="block hover:text-green-300">📦 Tất cả danh mục - Thêm - Sửa - Xóa</Link>
            </div>
          )}
        </div>
        ...
        <div>
          ...
          {userMenuOpen && (
            <div className="ml-6 mt-2 space-y-2 text-sm">
              <Link to="/admin/products" className="block hover:text-green-300">📦 Danh sách người dùng</Link>
        ...
        {/* Phân quyền & Bảo mật - chỉ manager nhìn thấy */}
        {isManager && (
          <div>
            <div
        ...
        {/* Cài đặt hệ thống - chỉ manager nhìn thấy */}
        {isManager && (
          <div>
            <div
